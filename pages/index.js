  ...
  return (
    <div className="min-h-screen bg-lavender dark:bg-dark-green-custom background-opacity-10 font-josephin-sans transition duration-150">
      ...
      <main className="w-full py-10 z-10">
        ...
        <MainContainer>
          <div className="w-full h-full flex border-2 border-dark-green-custom rounded-t-xl lg:rounded-l-xl lg:rounded-tr-none dark:bg-green-custom bg-dark-green-custom flex-col lg:flex-row">
            <Navbar
              isRunning={isRunning}
              counter={counter}
